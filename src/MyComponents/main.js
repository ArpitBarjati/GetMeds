...
export default function Main() {
  return (
    <div>
        ...
        <div style={{ padding: "5% 15%" }} className="pad-1">
          <div className="row">
            <div className="col-lg-6">
              <h1 id="text-1">
                Exactly what you need. Exactly where you need.
              </h1>
              <Link
                className="btn btn-dark btn-lg down-button"
                type="button"
                to="/order"
              >
              ...
              <Link
                className="btn btn-outline-light btn-lg down-button"
                type="button"
                to="/aboutus"
              >
        ...
        <div className="row">
          <div className="col-lg-4">
            <a href="https://www.cowin.gov.in/home">
              <i className="fas fa-viruses fa-4x ixa"></i>
            </a>
          ...
          <div className="col-lg-4">
            <a
              href="https://static.mygov.in/rest/s3fs-public/mygov_161725058451307401.pdf"
              target="_blank"
            >
              <i className="fas fa-heartbeat  fa-4x ixa"></i>
            </a>
        ...
        <div id="carousel1" className="carousel slide" data-ride="false">
          <div className="carousel-inner">
            ...
            <div className="carousel-item">
              <h2 className="testimonials-in">
                Dr. Nina uses GetMeds on regular basis and recommends to others.
              </h2>
      ...
      <section id="pricing">
        <h2 style={{ margin: "2% auto", color: "gray" }} className="pricing-in">
          A Plan for EveryOne's Needs
        </h2>
        <p className="para-price">
          Simple and affordable price plans for you and your medical needs
        </p>
